<html><head>
    ...
    <!-- BEGIN PAGES CSS -->
  <script type="text/javascript" async="" src="https://www.googletagmanager.com/gtag/js?id=G-C2LW91T579&amp;l=dataLayer&amp;cx=c&amp;gtm=453e52d0za200"></script><script src="https://www.googletagmanager.com/gtag/js?l=dataLayer" async=""></script></head>
  <body class="pace-danger  mac desktop pace-done"><div class="pace  pace-inactive"><div class="pace-progress" data-progress-text="100%" data-progress="99" style="width: 100%;">
  <div class="pace-progress-inner"></div>
</div>
<div class="pace-activity"></div></div>
    <!-- BEGIN JUMBOTRON -->
    <section class="jumbotron last full-height xs-full-height z-index-10" data-pages="parallax" data-pages-bg-image="assets/images/Hero.jpg" style="margin-bottom: 483px; background-image: url(&quot;assets/images/Hero.jpg&quot;); background-position: center 50%;">
            ...
            <div class="row">
              <div class="col-sm-10 col-sm-offset-1">
                <div class="text-center sm-p-t-30">
                  <img src="assets/images/logo-header.png" width="152" height="21" data-src-retina="assets/images/logo_black_2x.png" alt="" class="m-b-30">
                  <h1 class="font-montserrat text-uppercase hidden-xs">Perfection Simplified</h1>
                  <h2 class="font-montserrat text-uppercase visible-xs">Perfection Simplified</h2>
                  <h4>Sign up for our spam free newsletter</h4>
                </div>
              </div>
            </div>
            <div class="row">
                  ...
                  <form class="m-t-40 m-b-5 clearfix">
                    ...
                    <div class="col-sm-7  p-l-10 sm-p-l-15">
                      <div class="form-group form-group-default input-group input-group-attached col-xs-12">
                       ...
                       <button class="btn btn-danger  btn-cons" type="button">Sign Up</button>
                    </span>
                      </div>
                      <p class="fs-12 pull-right text-right m-r-20">Be first to find out when we Launch our product.</p>
                    </div>
                  </form>
                </div>
              </div>
    ...
    <div class="bg-overlay" style="opacity: 0;"></div></section>
    <!-- END JUMBOTRON -->
    <!-- START FOOTER -->
    <section class="z-index-1 pull-bottom-fixed full-width" data-pages="reveal-footer">
      <section class="p-b-70 p-t-55 ">
        <div class="container">
          <div class="row">
            <div class="col-md-7">
              <img alt="" src="assets/images/logo_black.png">
            </div>
            <div class="col-md-5">
      ...
      <section class="p-t-10 p-b-10 bg-master-darkest">
        <div class="container">
          <div class="row">
            <div class="col-sm-7">
              <p class="fs-11 no-margin font-arial text-white small-text"><span class="hint-text">Exclusive only at</span> Envato Marketplace,Themeforest <span class="hint-text">See</span> Standard licenses &amp; Extended licenses
              </p>
            </div>
            <div class="col-sm-5 text-right">
              <p class="fs-11 no-margin font-arial text-white small-text">Copyright © 2014 REVOX. All Rights Reserved.
              </p>
            </div>
          </div>
        </div>
