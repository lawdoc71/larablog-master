...
@section('content')
    ...
    <form action="{{ route('admin.create_page') }}" method="POST" autocomplete="off" enctype="multipart/form-data" id="addPageForm">
                ...
                <div class="card card-box mb-2">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="content" id="content" cols="30" rows="10" class="ckeditor form-control" placeholder="Enter page content here..."></textarea>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="custom-control custom-checkbox mb-5">
                                    <input type="checkbox" class="custom-control-input" id="customCheck1" name="show_on_header" value="1">
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="custom-control custom-checkbox mb-5">
                                    <input type="checkbox" class="custom-control-input" id="customCheck2" name="show_on_footer" value="1" checked>
