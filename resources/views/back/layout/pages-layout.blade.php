...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        ...
        <link rel="stylesheet" href="/extra-assets/nicelabel/css/jquery-nicelabel.css">
    ...
    <body>
                    ...
                    <ul id="accordion-menu">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="submenu">
                                ...
                                <li>
                                    <a href="{{ route('admin.add_post') }}" class="{{ Route::is('admin.add_post') ? 'active' : '' }}">New</a>
                                </li>

                                <li>
                                    <a href="{{ route('admin.posts') }}" class="{{ Route::is('admin.posts') ? 'active' : '' }}">Posts</a>
                                </li>
                        ...
                        @if ( auth()->user()->type == 'superAdmin' )
                            ...
                            <li class="dropdown">
                                <a href="javascript:;" class="dropdown-toggle {{ Route::is('admin.add_page') || Route::is('admin.pages') || Route::is('admin.edit_page') ? 'active' : '' }}">
                                    <span class="micon bi bi-file-earmark-spreadsheet"></span>
                                    <span class="mtext">Pages</span>
                                </a>
                                <ul class="submenu">
                                    <li>
                                        {{-- <a href="{{ route('admin.add_page') }}" class="{{ Route::is('admin.add_page') ? 'active' : '' }}">New</a> --}}
                                    </li>
                                    <li>
                                        {{-- <a href="{{ route('admin.pages') }}" class="{{ Route::is('admin.pages') ? 'active' : '' }}">All pages</a> --}}
                                    </li>
                                </ul>
                            </li>
                        ...
                        @if ( auth()->user()->type == 'superAdmin' )
                            ...
                            <li>
                                <a href="{{ route('admin.slider') }}" class="dropdown-toggle no-arrow {{ Route::is('admin.slider') ? 'active' : '' }}">
        ...
        <div class="main-container">
            ...
            <div class="pd-ltr-20 xs-pd-20-10">
                ...
                <div class="footer-wrap pd-20 mb-20 card-box">
                    ...
                    <p class="content">&copy; {{ date('Y') }} - Design &amp; Develop By Butler Transport</p>
        ...
        <script src="/extra-assets/nicelabel/js/jquery.nicelabel.js"></script>
